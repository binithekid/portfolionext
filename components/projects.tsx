  ...
  return (
    <section className="p-8 md:px-14 flex flex-col gap-4">
      ...
      >
        ...
        <h1 className="font-CalSans text-3xl">Aim Hire AI</h1>
        <p className="text-sm">
          Aimhire transforms your job search with a cutting-edge, full-stack
          platform. Powered by Firebase, it seamlessly integrates Next.js for a
          responsive user experience. Utilizing AI, it elevates your CVs and
          cover letters. Styled with Tailwind CSS for a sleek design, Aimhire.ai
          combines technology and career success seamlessly!
        </p>
